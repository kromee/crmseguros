            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-3">
              ...
              <div className="col-span-2 space-y-2">
                ...
                <button
                  ...
                  className="w-full rounded-lg border border-dashed border-slate-300 bg-slate-50 px-3 py-2.5 text-xs text-slate-600 flex items-center justify-center gap-2 hover:bg-slate-100 disabled:opacity-50"
                >
