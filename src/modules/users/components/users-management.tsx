      ...
      <div className="crm-card p-5">
        ...
        <input
          ...
          onChange={(e) => {
            ...
            uploadAvatar(targetUserId, file);
          }}
        />
        <div className="space-y-3">
          {users.map((u) => (
            <div key={u.id} className="flex items-center gap-3 p-3 rounded-lg border border-slate-100">
              ...
              <span className={`text-[10px] px-2 py-1 rounded-full font-semibold ${u.role === "ADMIN" ? "bg-purple-100 text-purple-700" : "bg-slate-100 text-slate-700"}`}>
                {u.role}
              </span>
